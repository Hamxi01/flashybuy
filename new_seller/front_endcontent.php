        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <form method="post" action="php/front_endcontent.php" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" placeholder="Enter Heading" name="heading" class="form-control">
                      </div>  
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="sub_heading" placeholder="Sub Heading" class="form-control">
                      </div>  
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" placeholder="First Point" name="first" class="form-control">
                      </div>  
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" placeholder="Second Point" name="second_point" class="form-control">
                      </div>  
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" placeholder="Third point" name="third_point" class="form-control">
                      </div>  
                    </div>
