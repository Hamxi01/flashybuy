<?php 
 ...
 if (isset($_REQUEST['action']) && $_REQUEST['action'] =='insert') {
        ...
        $p  = "INSERT INTO vendor_product_deals SET product_id = '$product_id' , deal_NO = 10040 , v_p_id = '$v_p_id' , start_date = '$start_date' , end_date = '$end_date', deal_price = '$deal_price', deal_quantity = '$deal_quantity', market_price = '$deal_market_price' ,variation_id='$variation_id'";
        $sP = mysqli_query( $con , $p  );
        echo "<script>window.location.assign('dealblock2.php?msg=success');</script>";
        exit;
 }     
?>
      <!-- Main Content -->
                ...
                <div class="card">
                  <div class="card-body p-0">
                      <table class="table table-bordered">
                        ...
                        <tbody> 
<?php
$pQ =  "SELECT P.*,VPD.v_p_id,VPD.start_date,VPD.end_date,VPD.deal_price,VPD.deal_quantity,VPD.market_price   FROM products AS P INNER JOIN vendor_product_deals AS VPD ON P.product_id = VPD.product_id  WHERE VPD.deal_NO = 10040  ";
