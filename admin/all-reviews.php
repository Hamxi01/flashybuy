...
<div class="row">
    ...
    <?php echo "<span>Review Accepted...!!</span>"; ?>
...
<?php
if (isset($_GET['msg']) && $_GET['msg'] == 'reject') { ?>
<div class="row">
    <div class="col-lg-6 col-sm-offset-3">
        <div class="alert alert-danger msg">    
    <?php echo "<span>Review Rejected...!!</span>"; ?>
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tbody>
<?php 
$prSql = mysqli_query($con,"SELECT * FROM product_reviews WHERE approved ='Y' AND reject = 'N' ORDER BY p_r_id DESC");
