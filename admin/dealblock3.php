...
$s = "SELECT * FROM vendor_product_deals WHERE product_id = '$product_id' AND deal_NO = '10050'";
                ...
                <div class="card">
                  <div class="card-body p-0">
                      <table class="table table-bordered">
                        ...
                        <tbody> 
<?php
$pQ =  "SELECT P.*,VPD.v_p_id,VPD.start_date,VPD.end_date,VPD.deal_price,VPD.deal_quantity,VPD.market_price   FROM products AS P INNER JOIN vendor_product_deals AS VPD ON P.product_id = VPD.product_id  WHERE VPD.deal_NO = 10050  ";
