...
if (isset($_GET['order_ids'])) {
    ...
    $oSql  = " UPDATE orders SET order_ship_draft = 'Y' WHERE order_ids = '$order_ids'" ;

  if ($oQuery = mysqli_query( $con , $oSql )) {
      
      echo '<script type="text/javascript">window.location.href = "view-order-draft.php?msg=success"</script>';
  }  
...
<div class="row">
    ...
    <?php echo "<span>Order ready to Shipped...!!</span>"; ?>
    ...
    ?>                     
                        <thead>
                          <tr>
                            ...
                            <th colspan="3"> order No : <?=$order_transaction?></th>
                          </tr>
                        </thead>
                        <tr  style="background:#EBFFE9 !important">
                          ...
                          <tr>
                            ...
                            <th><?=$order_price?></th>
                            <th><?=$orderStatus?></th>
                            <th><button class="btn btn-dark"><a style="color: white;text-decoration: none" href="view-order-waybill.php?order_ids=<?=$order_ids?>">WayBill Request</a></button></th>
                          </tr>
<?php } ?>                      
                      </table>
                  </div>
