...
while ( $categoryResult = mysqli_fetch_array($categorySql)) { ?>
    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 ">
                        <div class="ps-block--category"><a class="ps-block__overlay" href="product-list.php?cat_id=<?=$categoryResult['cat_id']?>"></a><img src="upload/category/170_<?=$categoryResult['banner'];?>" alt="">
