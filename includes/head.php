...
/*.thumbnail{  border: 10px solid #fdd922;}*/
...
<!-- <header class="header header--product" data-sticky="true">
        ...
        <nav class="navigation">
            <div class="ps-container">
                ...
                <div class="navigation__right">
                    <ul class="menu">
                        <li ><a></a><span class="sub-toggle"></span>
</li>
</ul>
                  
                    <ul class="navigation__extra">
                        <li><a href="vendor.php">Sell on Flashybuy</a></li>
    ...
    <header class="header header--mobile" data-sticky="true">
        ...
        <div class="navigation--mobile">
            <div class="navigation__left"><a class="ps-logo" href="index.php"><img src="img/logo.png" alt=""></a></div>
            <div class="navigation__right">
    ...
    <div class="ps-panel--sidebar" id="menu-mobile">
        ...
        <div class="ps-panel__content">
            <ul class="menu--mobile">
                <li class="menu-item-has-children"><a href="index.php">Home</a><span class="sub-toggle"></span>
                    <ul class="sub-menu">
                        <li class="current-menu-item "><a href="index.php">Marketplace Full Width</a>
                        </li>
