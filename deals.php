    ...
    <div class="ps-page--shop">
        <div class="ps-container">
            ...
            <!-- <div class="ps-shop-brand">
                <a href="#"><img src="img/brand/1.jpg" alt=""></a><a href="#"><img src="img/brand/2.jpg" alt=""></a><a href="#"><img src="img/brand/3.jpg" alt=""></a><a href="#"><img src="img/brand/4.jpg" alt=""></a><a href="#"><img src="img/brand/5.jpg" alt=""></a><a href="#"><img src="img/brand/6.jpg" alt=""></a><a href="#"><img src="img/brand/7.jpg" alt=""></a><a href="#"><img src="img/brand/8.jpg" alt=""></a>
            </div> -->
...
$dSql = mysqli_query($con,"SELECT P.*,VPD.v_p_id,VPD.deal_price,VPD.start_date,VPD.end_date,VPD.deal_quantity,VPD.market_price , VPD.deal_NO ,VPD.v_p_d_id,VP.quantity 
                    ...
                    WHERE   1 = 1  
                            AND VP.active = 'Y'
                            AND VP.price > 0
                            AND deal_NO='$deal_NO' group by product_id
...
?>                                        
                            ...
                            <div class="ps-product__container"><a class="ps-product__vendor" href="#">Go Pro</a>
                                <div class="ps-product__content"><a class="ps-product__title" href="product.php?id=<?=base64_encode($product_id)?>&name=<?=str_replace(' ','-',$name)?>"><?=$name?></a>
                                    ...
                                    <p class="ps-product__price sale">R<?=$deal_price?></del></p>
                                </div>
...
<?php } }else{
                ...
                echo '<h4 style="text-align:center">Currently no product in deal.</h4>';
}   ?>                                     
