...
if (isset($_POST['product_id'])) {
	...
	$vpsql = "SELECT price,quantity,ven_id,dispatched_days from vendor_product where prod_id='$product_id' AND variation_id = '$variation_id' AND ven_id !='$vendor_id'";
	...
	$result   = mysqli_fetch_array($vpquery);
	 ...
	 while ($pro = mysqli_fetch_array($vpquery)) {
		...
		echo '<div class="col-md-12">
                                    <h4><b>R'.$price.'</b><button class="btn btn-warning" style="float: right;">Add to cart</button></h4>
