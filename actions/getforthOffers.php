...
//========= GET other vendor product price ===============//
 	...
 	$vpSql = mysqli_query($con,"SELECT price,dispatched_days,ven_id FROM vendor_product WHERE prod_id='$product_id' AND variation_id ='$variation_id' AND ven_id!='$vendor_id'");
