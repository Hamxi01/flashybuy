...
$query =  mysqli_query($con,"insert into vendor (name,lastname,shop_name,email,mobile,phone,company,cat_name,website,social,vat,vat_number,monthly_revenue,business_reg,adiotional_coment) values('$name','$lastname','$shop_name','$email','$mobile','$phone','$company','','$website','','$vat','$vat_number','$monthly_rev','$bus_number','$add_comment')");
if ($query==true) 
{
