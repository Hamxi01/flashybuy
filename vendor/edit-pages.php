...
<?php    
    $id = base64_decode($_GET['id']);
     if(isset($_POST['form_category'])){
        ...
        $query = "update pages SET name='".$name."', subject='".$subject."', content='".$content."' Where id='".$id."'";       
        
        if (mysqli_query($con,$query)){

            echo "<script>window.location.assign('pages.php');</script>";
            $msg = "<span>Template updated successfully...!!</span>";
        }
        else{ 
            header("location:edit-pages.php?id=".$id);
...
<!-- End Message Alert -->
                       <div class="row">
                            <div class="col-lg-6 col-sm-offset-3">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Page Information</b></h4>
